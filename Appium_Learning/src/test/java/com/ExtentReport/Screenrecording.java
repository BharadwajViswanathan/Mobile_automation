...
//			Rectangle captureSize = new Rectangle(0, 0, width, height);
			...
			screenRecorder = new Screenrecording(gc, null,
					new Format(MediaTypeKey, MediaType.FILE, MimeTypeKey, MIME_QUICKTIME),
					new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_QUICKTIME_PNG,
							CompressorNameKey, ENCODING_QUICKTIME_PNG, DepthKey, 24, FrameRateKey,
...
//			Screenrecording.startRecording("navigation_FeatureTest");
